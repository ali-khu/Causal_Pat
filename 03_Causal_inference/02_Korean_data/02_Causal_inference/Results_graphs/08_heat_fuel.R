...
data <- read_excel('With_confounders.xlsx', sheet = "heat_fuel")
...
jpeg("08_heat_fuel.jpeg", units="cm", width=30, height=15, res=300)
ggplot(data, aes(x = Variable, y =EUI,
  ...
  scale_x_discrete(guide = guide_axis(n.dodge=2), labels= my_labels)+
  # coord_flip()+
  theme_bw()+
